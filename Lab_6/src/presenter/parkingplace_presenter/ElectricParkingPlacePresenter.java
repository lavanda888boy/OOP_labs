    ...
    private void chargeTheCar(ElectricCar car) {
        ...
        if (bc == bv) {
            ...
            if (electricParkingPlace.getCurrentVolume() < bc - bv) {
                ...
                electricCarView.printCarBatteryVolume(
                        (Math.round((double) (car.getBatteryVolume()) / (double) (car.getBatteryCapacity()) * 100)));
                ...
                electricParkingPlaceView
                        .printChargerVolume((Math.round((double) (electricParkingPlace.getCurrentVolume())
